...
public class ObjGraficosService {
    ...
    private ObjGraficosService() {}
     ...
     // posicion x, posision y, ancho, alto, color background, borde
     ...
     */
     public JScrollPane construirPanelBarra(
        ...
        /**
       * @param texto resive un String
       * @param x es la posicion en el eje x
       * @param y posicion en el eje y
       * @param ancho el ancho
       * @param alto el alto
       * @param cursor objeto decorador de tipo cursor
       * @param imagen  objeto decorador de tipo ImageIcon
       * @param fuente  objeto decorador de tipo Font
       * @param colorFondo  objeto decorador de tipo Color
       * @param colorFuente objeto decorador de tipo Color
       * @param borde   objeto decorador de tipo Border
       * @param direccion   Representa la posición horizontal del objeto que contenga el botón
       *                    'c' (Center) contendido centrado (DEFAUT)
       *                    't' (Top) Contenido centrado con texto en el parte superior de una imagen
       *                    'l' (Left) contenido recostado a la izquierda
       *                    'r' (Right) contenido recostado a la derecha
       *                    'b' (Bottom) contenido centrado con texto en la parte inferior de una imagen 
       * @param esSolido booleano para determinar un boton solido o transparente
       * @return
      */ 
